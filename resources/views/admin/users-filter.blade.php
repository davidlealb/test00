...
<div class="contentbar">
    ...
    <div id="users" class="row">
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="rodney-macneal" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="meghan-abo" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="kristie-aamdot" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
        ...
        <!-- Start col -->
        <div id="neil-aaron" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
                    <img src="assets/images/users/boy.svg" class="img-fluid" alt="doctor">
                    <h5>Neil Aaron</h5>
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="john-aase" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
                    <img src="assets/images/users/girl.svg" class="img-fluid" alt="doctor">
                    <h5>John Aase</h5>
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="naomi-wattson" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
                    <img src="assets/images/users/women.svg" class="img-fluid" alt="doctor">
                    <h5>Naomi Wattson</h5>
        ...
        <!-- End col -->
        <!-- Start col -->
        <div id="mark-wahlberg" class="col-lg-6 col-xl-3">
            <div class="card doctor-box m-b-30">
                <div class="card-body text-center">
                    <img src="assets/images/users/men.svg" class="img-fluid" alt="doctor">
                    <h5>Mark Wahlberg</h5>
...
function myFunction() {
  ...
  h5 = card.getElementsByTagName('h5');
        ...
        // alert(card.getElementsByTagName('h5').item(0).innerText);
        // alert(card.getElementsByTagName('h5').length);
        // alert(h5.length);

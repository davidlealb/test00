...
"use strict";
  $(document).ready(function() {
      ...
      markerMap.addMarker({
          lat: 49.2786581,
          lng: -123.1386105,
          icon: 'assets/images/svg-icon/savana1.png',
          title: 'Savana 1: Loading since 9:00 am',
          infoWindow: {
              content: '<p>Loading since 9:00 am</p>'
          }
      });
      markerMap.addMarker({
          lat: 49.2886581,
          lng: -123.1368105,
          icon: 'assets/images/svg-icon/savana2.png',
          title: 'Savana 2: Unloading since 11:00 am',
          infoWindow: {
              content: '<p>Unloading since 11:00 am</p>'
          }
      });
